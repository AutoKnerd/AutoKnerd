export const siteContent = {
  ...
  process: {
    title: "How AutoKnerd Works",
    steps: [
      {
        number: 1,
        title: "CX Diagnostic Audit",
        description: "Identify breakdowns in the dealership customer journey."
      },
      {
        number: 2,
        title: "Infrastructure Deployment",
        description: "Install AutoForge and AutoDriveCX behavioral systems."
      },
      {
        number: 3,
        title: "Manager Execution Protocols",
        description: "Managers run weekly coaching and reinforcement cycles."
      },
      {
        number: 4,
        title: "Performance Stabilization",
        description: "Customer trust, consistency, and CSI improve over time."
      }
    ]
  },
  impact: {
    title: "CX Impact Indicators",
    description: "Dealerships implementing the AutoKnerd system see improvements in:",
    indicators: [
  ...
  podcast: {
    title: "The AutoKnerd Podcast",
    description: "Trusted by dealership professionals seeking smarter approaches to CX, leadership, and trust-based selling. Explore the intersection of psychology and dealership performance.",
